...
public final class Assets {
    ...
    static final String CRASH_SOUND     = "crash.au";
    static final String EXPLOSION_SOUND = "explosion.au";
    static final String FIRE_SOUND      = "fire.au";
    static final String MISSLE_SOUND    = "missle.au";
    static final String SAUCER_SOUND    = "saucer.au";
    static final String THRUSTERS_SOUND = "thrusters.au";
    static final String WARP_SOUND      = "warp.au";
}